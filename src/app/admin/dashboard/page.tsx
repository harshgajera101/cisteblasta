...
//                        <span className="font-bold text-[#4E342E]">Address:</span>
//                        <span className="flex-1">{order.address}</span>
//                      </div>
//                      <div className="flex items-center gap-2">
//                        <Mail size={16} className="text-[#D98292] shrink-0" />
//                        <span className="font-bold text-[#4E342E]">Email:</span>
//                        <span>{order.email || "N/A"}</span>
//                      </div>
//                      <div className="flex items-center gap-2">
//                        <Phone size={16} className="text-[#D98292] shrink-0" />
//                        <span className="font-bold text-[#4E342E]">Phone:</span>
