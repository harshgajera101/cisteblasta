...
// import { RefreshCw, Check, Truck, ChefHat, Package, Clock, RotateCcw, Plus, Trash2, Edit2, Image as ImageIcon, X } from "lucide-react";
...
//   // Filter for Products
//   const [menuFilter, setMenuFilter] = useState("ALL"); // NEW: Filter State
...
//     // Pricing Logic
//     hasVariants: false,
//     basePrice: "", // Simple Price
//     variants: [] as { name: string; price: string }[] // Complex Pricing
//   });
...
//     // Send Price OR Variants
//     if (formData.hasVariants) {
//       // Filter out empty rows and convert price to number
//       const validVariants = formData.variants
//         .filter(v => v.name && v.price)
//         .map(v => ({ name: v.name, price: parseFloat(v.price) }));
      
//       if(validVariants.length === 0) {
//         showToast("Please add at least one size option", "error");
//         setIsUploading(false);
//         return;
//       }
//       data.append("variants", JSON.stringify(validVariants));
//       data.append("price", "0"); // Placeholder
//     } else {
...
//       if (res.ok) {
//         showToast(editingId ? "Item updated successfully!" : "New item added to menu!", "success");
//         setFormData({ 
//           name: "", category: "CAKE", description: "", image: null, 
//           hasVariants: false, basePrice: "", variants: [] 
//         }); 
//         setEditingId(null);
//         fetchProducts(); 
//       } else {
...
//     // Custom Confirm using window.confirm (or you can build a Modal component)
...
//                      className="w-4 h-4 text-[#D98292] focus:ring-[#D98292] rounded border-gray-300"
//                    />
...
//                       </div>
//                     ))}
//                     <button type="button" onClick={addVariant} className="text-xs font-bold text-[#D98292] flex items-center gap-1 mt-2 hover:underline">
...
//                 </button>
//                 {editingId && (
//                   <button type="button" onClick={() => { setEditingId(null); setFormData({ name: "", category: "CAKE", description: "", image: null, hasVariants: false, basePrice: "", variants: [] }); }} className="px-4 py-3 bg-gray-100 text-gray-500 font-bold rounded-xl hover:bg-gray-200">
//                     Cancel
//                   </button>
//                 )}
//               </div>
...
//                      className={`px-3 py-1 text-[10px] font-bold rounded-md transition ${menuFilter === cat ? "bg-[#D98292] text-white" : "text-[#8D6E63] hover:bg-[#FFF8F3]"}`}
//                    >
//                      {cat}
//                    </button>
//                  ))}
...
//                   <button onClick={() => handleDeleteProduct(product._id)} className="p-2 text-red-400 hover:bg-red-50 rounded-lg transition"><Trash2 size={18} /></button>
//                 </div>
//               </div>
//             ))}
//           </div>
